...
import kotlinx.android.synthetic.main.fragment_add_item_fourth.*
...
class AddItemFourthFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        fragmentView.fragment_add_item_fourth_rating.setOnRatingBarChangeListener { ratingBar, fl, b ->
            ...
            viewModel.tempItemDTO.value!!.ratingReview = fragmentView.fragment_add_item_fourth_rating.rating
        }
        ...
        fragmentView.fragment_add_item_fourth_text_review.doAfterTextChanged {
            viewModel.tempItemDTO.value!!.review = fragment_add_item_fourth_text_review.text.toString()
        }
